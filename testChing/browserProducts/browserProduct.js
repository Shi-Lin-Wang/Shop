...
function showProduct(img,name,price,num, id){
	...
	var block = $('#block'+num);
	var check = $('<a/>')
	.html('<div class="abgne_tip_gallery_block" style="margin:0 auto;"><a href="../viewProduct/viewProduct.html?id='+id+'"><img src="../uploadImg/'+img+'" class="img-responsive" style="width:213px; height:213px;" alt="Image"></a>'+
		  '<div class="caption"><h4><a href="../viewProduct/viewProduct.html?id='+id+'" title="標題" style="line-height: 28px; margin-top:-3px; display:inline-block;">'+ name +'</a></h4><div class="desc" style="padding-right:10px; word-break: break-all;">'+
