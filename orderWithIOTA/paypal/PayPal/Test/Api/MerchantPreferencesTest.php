...
class MerchantPreferencesTest extends TestCase
{
     ...
     * @expectedException CancelUrl is not a fully qualified URL
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedException ReturnUrl is not a fully qualified URL
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedException NotifyUrl is not a fully qualified URL
     */
